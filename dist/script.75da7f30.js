...
},{"process":"../../../Users/Joshua/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
window.jQuery = window.$ = _jquery.default; // let json = require('/data.json');

window.addEventListener('DOMContentLoaded', init);

function init() {
  console.log('hello');
  dot.classList.add('active-dot'); // loadJSON();
  // animateLogo();
...
function onClickAdd() {
  svg1.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg1-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg1, 1, {
      x: -500,
      scale: 1.5
  ...
  svg2.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg2-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg2, 1, {
      x: 500,
      scale: 1.5
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
  ...
  svg3.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg3-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg3, 1, {
      x: -500,
      scale: 1.5
    });
  }); //
  ...
  svg4.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg4-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg4, 1, {
      x: 500,
      scale: 1.5
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
  ...
  svg5.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg5-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg5, 1, {
      x: -500,
      scale: 1.5
    });
  }); //
  ...
  svg6.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg6-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg6, 1, {
      x: 500,
      scale: 1.5
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
  ...
  svg7.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg7-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg7, 1, {
      x: -500,
      scale: 1.5
    });
  }); //
  ...
  svg8.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg8-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg8, 1, {
      x: 500,
      scale: 0.5
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
  ...
  svg9.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg9-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg9, 1, {
      x: -500,
      scale: 1.2
    });
  }); //
  ...
  svg10.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg10-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg10, 1, {
      x: 500,
      scale: 1.5
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
  ...
  svg11.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg11-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg11, 1, {
      x: -500,
      scale: 0.4
    });
  }); //
  ...
  svg12.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg12-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg12, 1, {
      x: 500,
      scale: 0.8
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
  ...
  svg13.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg13-info', 1, {
      x: 200,
      opacity: 1
    });

    _TweenMax.default.to(svg13, 1, {
      x: -500,
      scale: 1.5
    });
  }); //
  ...
  svg14.addEventListener("click", function () {
    ...
    _TweenMax.default.to('#svg14-info', 1, {
      x: -200,
      opacity: 1
    });

    _TweenMax.default.to(svg14, 1, {
      x: 500,
      scale: 1.5
    });
  }); ///////////////////////////////////////////////////////////////////////////////////////
...
var svg4 = document.querySelector('#svg-4');
var svg5 = document.querySelector('#svg-5');
var svg6 = document.querySelector('#svg-6');
var svg7 = document.querySelector('#svg-7');
var svg8 = document.querySelector('#svg-8');
var svg9 = document.querySelector('#svg-9');
var svg10 = document.querySelector('#svg-10');
var svg11 = document.querySelector('#svg-11');
var svg12 = document.querySelector('#svg-12');
var svg13 = document.querySelector('#svg-13');
var svg14 = document.querySelector('#svg-14');
...
var p11 = document.querySelector('#p-11');
var p12 = document.querySelector('#p-12');
var p13 = document.querySelector('#p-13');
var p14 = document.querySelector('#p-14');
var siliconValleySVG = document.querySelector('#siliconvalley-svg'); // Actions when scrolling, making the website dynamic

(0, _jquery.default)(window).scroll(function (event) {
  var scrollPositionTop = (0, _jquery.default)(window).scrollTop();
  var scrollPositionBottom = (0, _jquery.default)(window).scrollTop() + (0, _jquery.default)(window).height();
  console.log(scrollPositionBottom + 'Bottom');
  console.log(scrollPositionTop); // Do something
  // Moving clouds based on where the scroll position at the top is.

  cloud1.style.transform = "translate( ".concat(scrollPositionTop, "px, ", 0, "px)");
  cloud2.style.transform = "translate( ".concat(-scrollPositionTop, "px, ", 0, "px)");
  cloud3.style.transform = "translate( ".concat(scrollPositionTop, "px, ", 0, "px)");
  cloud4.style.transform = "translate( ".concat(-scrollPositionTop, "px, ", 0, "px)");
  cloud5.style.transform = "translate( ".concat(scrollPositionTop, "px, ", 0, "px)");
  cloud6.style.transform = "translate( ".concat(-scrollPositionTop, "px, ", 0, "px)");
  cloud7.style.transform = "translate( ".concat(-scrollPositionTop, "px, ", 0, "px)");
  /* Styling the year scroll */

  checkScroll(scrollPositionBottom, scrollPositionTop);
  console.log((0, _jquery.default)(svg2).offset().top + 'svg2top');
});

function checkScroll(scrollBtm, scrollTp) {
  if (scrollBtm < (0, _jquery.default)(svg1).offset().top) {
  ...
  if (scrollBtm > (0, _jquery.default)(svg2).offset().top) {
    console.log('lol');
    p1.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg3).offset().top) {
    console.log('lol');
    p2.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg4).offset().top) {
    console.log('lol');
    p3.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg5).offset().top) {
    console.log('lol');
    p4.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg6).offset().top) {
    console.log('lol');
    p5.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg7).offset().top) {
    console.log('lol');
    p6.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg8).offset().top) {
    console.log('lol');
    p7.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg9).offset().top) {
    console.log('lol');
    p8.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg10).offset().top) {
    console.log('lol');
    p9.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg11).offset().top) {
    console.log('lol');
    p10.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg12).offset().top) {
    console.log('lol');
    p11.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg13).offset().top) {
    console.log('lol');
    p12.classList.remove('active');
  ...
  if (scrollBtm > (0, _jquery.default)(svg14).offset().top) {
    console.log('lol');
    p13.classList.remove('active');
...
(0, _jquery.default)(dot).on('click', function (el) {
  el.preventDefault();
...
(0, _jquery.default)(p1).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg1).offset().top + (0, _jquery.default)(svg1).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
});
(0, _jquery.default)(p2).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg2).offset().top + (0, _jquery.default)(svg2).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
});
(0, _jquery.default)(p3).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg3).offset().top + (0, _jquery.default)(svg3).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p4).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg4).offset().top + (0, _jquery.default)(svg4).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p5).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg5).offset().top + (0, _jquery.default)(svg5).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p6).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg6).offset().top + (0, _jquery.default)(svg6).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p7).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg7).offset().top + (0, _jquery.default)(svg7).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p8).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg8).offset().top + (0, _jquery.default)(svg8).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p9).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg9).offset().top + (0, _jquery.default)(svg9).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p10).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg10).offset().top + (0, _jquery.default)(svg10).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p11).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg11).offset().top + (0, _jquery.default)(svg11).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p12).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg12).offset().top + (0, _jquery.default)(svg12).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p13).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg13).offset().top + (0, _jquery.default)(svg13).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //

(0, _jquery.default)(p14).on('click', function (el) {
  el.preventDefault();
  (0, _jquery.default)('html, body').animate({
    scrollTop: (0, _jquery.default)(svg14).offset().top + (0, _jquery.default)(svg14).height() / 2 - (0, _jquery.default)(window).height() / 2
  }, 500, 'swing');
}); //
// Onclick Ends
...
function loadJSON(){
  ...
  */
},{"gsap/TweenMax":"node_modules/gsap/TweenMax.js","jquery":"node_modules/jquery/dist/jquery.js"}],"../../../Users/Joshua/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../Users/Joshua/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.js"], null)
